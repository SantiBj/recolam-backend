    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weightAvg', models.DecimalField(decimal_places=3, max_digits=6)),
                ('details', models.CharField(max_length=300)),
                ('isComplete', models.BooleanField(default=False)),
                ('isDisable', models.BooleanField(default=False)),
                ('truck', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='trips.truck')),
